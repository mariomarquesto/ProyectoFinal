...
const ConfiguracionPadre = () => {
  ...
  const handleUpdate = () => {
    axios.put(`http://localhost:3000/parents/${formData.id}`, formData)
      .then(response => {
        console.log(response.data);
        alert('Padre actualizado con éxito');
      })
      .catch(error => {
        console.error('Error al actualizar el padre:', error.response);
        alert('Hubo un error al actualizar el padre');
  ...
  return (
    <Container>
      <h1 className="mt-4 mb-4">Modificar Padre</h1>
      <Form>
